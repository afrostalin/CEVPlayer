...
public:
	...
	virtual void AddListener(IVideoPlayerEventListener* pVideoPlayerListener) override;
	virtual void RemoveListener(IVideoPlayerEventListener* pVideoPlayerListener) override;
	// ~IVideoPlugin
public:
	void        RegisterCVars();
